...
async function initializeDatabase() {
    ...
    if (activeMysqlPool) {
        ...
        // ── EBD ──────────────────────────────────────────────────────────────
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS ebd_turmas (
            id INT AUTO_INCREMENT PRIMARY KEY,
            igreja_id INT NOT NULL,
            nome VARCHAR(255) NOT NULL,
            ano VARCHAR(10) NULL,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS ebd_alunos (
            id INT AUTO_INCREMENT PRIMARY KEY,
            igreja_id INT NOT NULL,
            turma_id INT NULL,
            nome VARCHAR(255) NOT NULL,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS ebd_apontamentos (
            id INT AUTO_INCREMENT PRIMARY KEY,
            turma_id INT NULL,
            igreja_id INT NOT NULL,
            data DATE NULL,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS ebd_presenca (
            id INT AUTO_INCREMENT PRIMARY KEY,
            igreja_id INT NOT NULL,
        ...
        // ── Escalas ──────────────────────────────────────────────────────────
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS escalas_eventos (
            id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS escalas_instancias (
            id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS escalas_evento_funcoes (
            id INT AUTO_INCREMENT PRIMARY KEY,
            event_id INT NOT NULL,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS escalas_grupos (
            id INT AUTO_INCREMENT PRIMARY KEY,
            church_id INT NOT NULL,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS escalas_funcoes (
            id INT AUTO_INCREMENT PRIMARY KEY,
            church_id INT NOT NULL,
            group_id INT NULL,
            name VARCHAR(255) NOT NULL,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS escalas_atribuicoes (
            id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        // ── Estudo / Ensino ──────────────────────────────────────────────────
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS estudo_versoes (
            id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS estudo_passagens (
            id INT AUTO_INCREMENT PRIMARY KEY,
            ...
            INDEX idx_ep_ref (versao_id, livro, capitulo, versiculo)
        )`);

        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS estudo_planos (
            id INT AUTO_INCREMENT PRIMARY KEY,
            igreja_id INT NULL,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS estudo_progresso (
            id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS estudo_anotacoes (
            id INT AUTO_INCREMENT PRIMARY KEY,
            user_id INT NOT NULL,
            igreja_id INT NOT NULL,
            versao_id INT NOT NULL,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS estudo_favoritos (
            id INT AUTO_INCREMENT PRIMARY KEY,
            user_id INT NOT NULL,
            igreja_id INT NOT NULL,
            versao_id INT NOT NULL,
            ...
            versiculo INT NOT NULL,
            created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
            UNIQUE KEY uq_favorito (user_id, versao_id, livro, capitulo, versiculo),
            INDEX idx_fav_user (user_id, igreja_id)
        )`);

        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS estudo_devocionais (
            id INT AUTO_INCREMENT PRIMARY KEY,
            igreja_id INT NULL,
        ...
        // ── Caixa ─────────────────────────────────────────────────────────────
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS caixa_meses (
            id INT AUTO_INCREMENT PRIMARY KEY,
            igreja_id INT NOT NULL,
        ...
        await activeMysqlPool.query(`CREATE TABLE IF NOT EXISTS caixa_lancamentos (
            id INT AUTO_INCREMENT PRIMARY KEY,
            igreja_id INT NOT NULL,
            data DATE NULL,
            doc VARCHAR(50) NULL,
